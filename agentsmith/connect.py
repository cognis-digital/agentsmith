"""Native cognis-connect emit for agentsmith — forward findings to any platform.

Maps agentsmith's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    agentsmith ... --format json | agentsmith-emit --to stix
    agentsmith-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""

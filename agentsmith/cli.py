"""AGENTSMITH command-line interface."""
from __future__ import annotations
import argparse, sys
from agentsmith.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="agentsmith", description="AGENTSMITH — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from agentsmith.mcp_server import serve
        return serve()
    if args.cmd == "scan":

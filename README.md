...
[![PyPI](https://img.shields.io/pypi/v/cognis-agentsmith.svg)](https://pypi.org/project/cognis-agentsmith/)
[![CI](https://github.com/cognis-digital/agentsmith/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/agentsmith/actions)
...
AGENTSMITH exists for one job — config-first scaffolding and orchestration for multi-agent workflows — and does it without a SaaS bill or heavyweight setup.
...
```bash
agentsmith --version
agentsmith scan .                      # scan the current project
agentsmith scan . --format json
agentsmith scan . --fail-on high       # non-zero exit for CI gates
agentsmith mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **CrewAI / Dify**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`agentsmith` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
